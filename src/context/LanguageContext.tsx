...
const translations: Translations = {
  ...
  de: {
    ...
    // Exercise Instructions (Keys)
    'instruction.478.1': 'Setze dich bequem mit geradem Rücken hin.',
    'instruction.478.2': 'Lege die Zungenspitze gegen das Gewebe direkt hinter den oberen Schneidezähnen.',
    'instruction.478.3': 'Atme vollständig durch den Mund aus und mache dabei ein Rauschgeräusch.',
    'instruction.478.4': 'Schließe den Mund und atme leise durch die Nase ein, während du bis 4 zählst.',
    'instruction.478.5': 'Halte den Atem für 7 Sekunden an.',
    'instruction.478.6': 'Atme vollständig durch den Mund aus, mache ein Rauschgeräusch und zähle bis 8.',
    'instruction.478.7': 'Das ist ein Atemzug. Atme nun wieder ein und wiederhole den Zyklus noch dreimal für insgesamt vier Atemzüge.',

    'instruction.box.1': 'Setze dich aufrecht auf einen bequemen Stuhl.',
    'instruction.box.2': 'Atme langsam durch die Nase ein und zähle bis 4.',
    'instruction.box.3': 'Halte den Atem für 4 Sekunden an.',
    'instruction.box.4': 'Atme langsam durch den Mund aus und zähle bis 4.',
    'instruction.box.5': 'Halte den Atem für 4 Sekunden an, bevor du wieder einatmest.',
    'instruction.box.6': 'Wiederhole diesen Zyklus für mindestens 3 Minuten.',
