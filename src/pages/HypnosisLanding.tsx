...
const HYPNOSES: HypnosisItem[] = [
  {
    ...
    description: 'Am Abend fällt es oft schwer, den Tag loszulassen. Diese Hypnose führt dich sanft in eine wohlige körperliche Schwere, schaltet das Grübeln ab und begleitet dich in einen regenerierenden Schlaf.',
            ...
            >
              {isPlaying ? (
                ...
                <>
                  ...
                  <span>Kostenlos reinhören (12:54 Min.)</span>
                </>
              )}
            </button>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="space-y-2 flex-1 text-center sm:text-left">
              <span className="text-[11px] font-mono font-bold uppercase tracking-wider text-[var(--accent)]">
                Deine kostenlose Schnupper-Hypnose
              </span>
